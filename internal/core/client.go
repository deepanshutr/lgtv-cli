// Package core is an HTTP client for the lgtv-core daemon.
package core
...
// Wake sends WoL + waits for TCP 3001 on the core daemon's side.
func (c *Client) Wake(ctx context.Context) error {
	return c.do(ctx, "POST", "/wake", nil, nil)
}

func (c *Client) PowerOff(ctx context.Context) error {
	return c.do(ctx, "POST", "/power/off", nil, nil)
}
...
func (c *Client) SwitchInput(ctx context.Context, id string) error {
	return c.do(ctx, "POST", "/input/switch", map[string]any{"id": id}, nil)
}
